...
public abstract class Hilt_FragmentCurrent extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentCurrent_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectFragmentCurrent(UnsafeCasts.<FragmentCurrent>unsafeCast(this));
    }
  }
}
